...
{
    public partial class addItemQuad : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TecnicaId = table.Column<int>(type: "int", nullable: false),
                    QuadranteIdQuadrante = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Item_Quadrante_QuadranteIdQuadrante",
                        column: x => x.QuadranteIdQuadrante,
                        principalTable: "Quadrante",
                        principalColumn: "IdQuadrante",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Item_QuadranteIdQuadrante",
                table: "Item",
                column: "QuadranteIdQuadrante");
